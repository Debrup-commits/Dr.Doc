#!/usr/bin/env python3
"""
Quick test script for ASI:One uAgent
This script demonstrates how to send messages to the running uAgent
"""
...
async def interactive_chat():
    ...
    """
    print("🤖 ASI:One uAgent Quick Test")
    print("=" * 40)
